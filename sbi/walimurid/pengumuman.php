        ...
        <ul class="navbar-nav navbar-nav-right ml-auto">
          <li class="nav-item dropdown d-none d-xl-inline-flex user-dropdown ">
            <a class="nav-link " id="UserDropdown" href="#" data-toggle="dropdown" aria-expanded="false">
              <img class="img-xs rounded-circle ml-2" src="./../assets/images/ebcd036a0db50db993ae98ce380f64191642082944.png" alt="Profile image"> <span class="font-weight-normal dropdown-toggle">Hello, <?php echo $_SESSION['user']['username']; ?></span></a>
          ...
          <li class="nav-item" style="border-bottom: 1px solid rgb(236, 226, 226);">
            ...
            <div class="collapse" id="auth">
              <ul class="nav flex-column sub-menu">
                ...
                <li class="nav-item"> <a class="nav-link" href="kelola-catatan-wali-murid.html"> Kelola Catatan </a></li>
            ...
            <div class="col-md-12 grid-margin">
              <div class="card">
                <div class="card-body">
                  ...
                  ?>
                    <div class="row ">
                      <div class="col-md-12 report-inner-cards-wrapper">
                        <div class="report-inner-card color-5">
                          <div class="inner-card-text text-white text-start">
