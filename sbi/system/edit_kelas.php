...
if (isset($_GET['id'])) {
    ...
    $class_data = $conn->query("SELECT * FROM kelas WHERE id = $id")->fetch();
...
if ($_SERVER["REQUEST_METHOD"] === "POST") {
    ...
    $bagian = $_POST['bagian'];
    $tanggal = date('Y-m-d');
    $conn->query("UPDATE kelas SET nama_kelas = '$nama_kelas', bagian = '$bagian', tanggal = '$tanggal' WHERE id = $id");
    $status = 'Edit kelas berhasil';
                        ...
                        <div class="col-md-12 grid-margin">
                            ...
                            <form class="forms-sample" method="post">
                                <div class="form-group">
                                    ...
                                    <input type="text" style="border: solid rgb(187, 187, 187) 1px" class="form-control" id="nama_kelas" name="nama_kelas" value="<?php echo $class_data['nama_kelas']; ?>" required>
                                </div>
                                <div class="form-group">
                                    <label for="bagian">Bagian Kelas:</label>
                                    <select id="bagian" style="border: solid rgb(187, 187, 187) 1px" class="form-control" name="bagian" required>
                                        <option value="">Select Bagian Kelas</option>
                                        <option value="A" <?php if ($class_data['bagian'] === 'A') echo 'selected'; ?>>A</option>
                                        <option value="B" <?php if ($class_data['bagian'] === 'B') echo 'selected'; ?>>B</option>
                                        <option value="C" <?php if ($class_data['bagian'] === 'C') echo 'selected'; ?>>C</option>
                                        <option value="D" <?php if ($class_data['bagian'] === 'D') echo 'selected'; ?>>D</option>
                                        <option value="E" <?php if ($class_data['bagian'] === 'E') echo 'selected'; ?>>E</option>
                                        <option value="F" <?php if ($class_data['bagian'] === 'F') echo 'selected'; ?>>F</option>
