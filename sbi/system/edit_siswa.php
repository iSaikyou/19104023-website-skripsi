...
if (isset($_GET['id'])) {
    ...
    $class_data = $conn->query("SELECT * FROM siswa WHERE id_siswa = '$id'")->fetch(PDO::FETCH_ASSOC);
...
if ($_SERVER["REQUEST_METHOD"] === "POST") {
    ...
    if (empty($_FILES['foto_siswa']['name'])) {
        $foto_siswa = $class_data['foto_siswa'];
    }
    $foto_siswa = $_FILES['foto_siswa']['name'];
    $tmp = $_FILES['foto_siswa']['tmp_name'];
    $path = "../assets/img".$foto_siswa;

    if (move_uploaded_file($tmp, $path)) {
        $sql = "UPDATE siswa SET nama_siswa = '$nama_siswa', email_siswa = '$email_siswa', kelas_siswa = '$kelas_siswa', jk = '$jk', tgl_lahir = '$tgl_lahir', nama_ayah = '$nama_ayah', nama_ibu = '$nama_ibu', no_hp = '$no_hp', hp_alternatif = '$hp_alternatif', alamat = '$alamat', update_at = '$update_at', foto_siswa = '$foto_siswa' WHERE id_siswa = '$id_siswa'";
                        ...
                        <div class="col-md-12 grid-margin">
                            ...
                            <form action="" class="forms-sample" method="post" enctype="multipart/form-data">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="id_siswa" name="id_siswa" value="<?php echo $class_data['id_siswa']; ?>" readonly>
                                <div>
                                <div class="form-group">
                                    <label for="nama_siswa">Nama Siswa</label>
                                    <input type="text" class="form-control" id="nama_siswa" name="nama_siswa" value="<?php echo $class_data['nama_siswa']; ?>">
                                </div>
                                <div class="form-group">
                                    <label for="email_siswa">Email Siswa</label>
                                    <input type="email" class="form-control" id="email_siswa" name="email_siswa" value="<?php echo $class_data['email_siswa']; ?>">
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="date" class="form-control" id="tgl_lahir" name="tgl_lahir" value="<?php echo $class_data['tgl_lahir']; ?>">
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="nama_ayah" name="nama_ayah" value="<?php echo $class_data['nama_ayah']; ?>">
                                </div>
                                <div class="form-group">
                                    <label for="nama_ibu">Nama Ibu</label>
                                    <input type="text" class="form-control" id="nama_ibu" name="nama_ibu" value="<?php echo $class_data['nama_ibu']; ?>">
                                </div>
                                <div class="form-group">
                                    <label for="no_hp">No. HP</label>
                                    <input type="number" class="form-control" id="no_hp" name="no_hp" value="<?php echo $class_data['no_hp']; ?>">
                                </div>
                                <div class="form-group">
                                    <label for="hp_alternatif">No. HP Alternatif</label>
                                    <input type="number" class="form-control" id="hp_alternatif" name="hp_alternatif" value="<?php echo $class_data['hp_alternatif']; ?>">
                                </div>
                                <div class="form-group">
                                    <label for="alamat">Alamat</label>
                                    <textarea class="form-control" id="alamat" name="alamat"><?php echo $class_data['alamat']; ?></textarea>
                                </div>
