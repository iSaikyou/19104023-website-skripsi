                    ...
                    <table class="table">
                      <thead>
                        <tr>
                          ...
                          <th class="font-weight-bold">Bagian</th>
                      ...
                      <tbody>
                        ...
                        ?>
                          <tr>
                            ...
                            <td><?php echo $kelas['bagian']; ?></td>
                            <td><?php echo $kelas['tanggal']; ?></td>
                            <td>
                            <a href="../system/edit_kelas.php?id=<?php echo $kelas['id']; ?>" class="btn btn-primary btn-sm"><i class="icon-pencil"></i></a>
                            <a href="../system/delete_kelas.php?id=<?php echo $kelas['id']; ?>" class="btn btn-danger btn-sm" onclick="return confirm('Apakah Yakin Ingin Menghapus ?');"><i class="icon-trash"></i></a>
                            </td>
                          </tr>
                        <?php
                        }
