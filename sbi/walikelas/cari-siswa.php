      ...
      <div class="main-panel">
        <div class="content-wrapper">
          <div class="page-header">
            <h3 class="page-title"> Cari Siswa </h3>
                  ...
                  <div class="d-flex " style="width: 100%; gap: 2rem;">
                    <form method="post" action="">
                      <div class="form-group">
                        ...
                        <input id="searchdata" type="text" style="border: solid rgb(187, 187, 187) 1px" name="searchdata" required="true" class="form-control" placeholder="Cari Berdasarkan ID">
                      </div>
                    ...
                    <form method="post">
                      <div class="form-group">
                        ...
                        <select name="classid" class="form-control" style="border: solid rgb(187, 187, 187) 1px" required='true'>
                          <option value="">Pilih Tahun Ajaran</option>
                          <option value="">Tahun Ajaran 2020/2021</option>
                          <option value="">Tahun Ajaran 2021/2022</option>
                          <option value="">Tahun Ajaran 2022/2023</option>
                          <option value="">Tahun Ajaran 2023</option>
                        </select>
                      </div>
          ...
          <div class="d-sm-flex align-items-center mt-1">
            <h4 align="center">Data Siswa Ditemukan </h4>
          </div>
          <div class="row">
            <div class="col-lg-12">
                ...
                <table class="table">
                  ...
                  <tbody>
                    ...
                    if ($_SERVER["REQUEST_METHOD"] === "POST") {
                      // Get the search query and year from the form submission
                      $searchQuery = $_POST['searchdata'];
                      // $year = $_POST['classid'];
                      // Perform the database query to search for matching data
                      // For example, you can use a SQL query like this:
                      $sql = "SELECT * FROM siswa WHERE id_siswa = '$searchQuery' OR nama_siswa LIKE '%$searchQuery%' OR email_siswa LIKE '%$searchQuery%' OR kelas_siswa LIKE '%$searchQuery%'";
                      ...
                      if (mysqli_num_rows($result) > 0) {
                        ...
                        while ($row = mysqli_fetch_assoc($result)) {
                          echo "<tr>";
                          echo "<td>" . $no++ . "</td>";
                          echo "<td>" . date('Y', strtotime($row['update_at'])) . "</td>";
                          echo "<td>" . $row['id_siswa'] . "</td>";
                          echo "<td>" . $row['kelas_siswa'] . "</td>";
                          echo "<td>" . $row['nama_siswa'] . "</td>";
                          echo "<td>" . $row['email_siswa'] . "</td>";
