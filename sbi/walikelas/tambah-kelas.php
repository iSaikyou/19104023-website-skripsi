          ...
          <li class="nav-item dropdown d-none d-xl-inline-flex user-dropdown">
            ...
            <div class="dropdown-menu dropdown-menu-right navbar-dropdown" aria-labelledby="UserDropdown">
              <div class="dropdown-header d-flex">
                ...
                <div>
                  <p class="mb-1 mt-3"></p>
                  <p class="font-weight-light text-muted mb-0">handayani@gmail.com</p>
                </div>
              </div>
      ...
      <div class="main-panel">
        <div class="content-wrapper">
          ...
          <div class="row">
            ...
            <div class="col-lg-5 col-md-5 col-sm-12 grid-margin">
              <div class="card">
                <div class="card-body">

                  <form class="forms-sample" action="../system/add_kelas.php" method="post">

                    <div class="form-group">
                      <label for="exampleInputName1">Nama Kelas</label>
                      <input type="text" style="border: solid rgb(187, 187, 187) 1px" name="nama_kelas" class="form-control" required='true'>
                    </div>
                    <div class="form-group">
                      <label for="exampleInputEmail3">Bagian Kelas</label>
                      <select name="bagian" class="form-control" required='true' style="border: solid rgb(187, 187, 187) 1px">
                        <option value="">Bagian Kelas</option>
